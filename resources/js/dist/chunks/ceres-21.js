...
var render = function render() {
  ...
  }, [_c("dl", [_vm._t("before-item-sum"), _vm._v(" "), _vm.visibleFields.includes("basketValueNet") || _vm.visibleFields.includes("basket.value_of_items_net") ? [_c("dt", {
    class: {
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm._f("currency")(_vm.basket.couponDiscount)) + "\n                ")])] : _vm._e(), _vm._v(" "), _c("hr"), _vm._v(" "), _vm._t("before-total-sum"), _vm._v(" "), _vm.visibleFields.includes("totalSumNet") || _vm.visibleFields.includes("basket.order_total_net") ? [_c("dt", {
    class: {
      "font-weight-bold": _vm.showNetPrices
    }
  ...
  }, [_c("hr"), _vm._v(" "), (_vm.visibleFields.includes("additionalCosts") || _vm.visibleFields.includes("basket.additional_costs")) && _vm.propertiesWithAdditionalCosts.length ? [_vm._l(_vm.propertiesWithAdditionalCosts, function (property) {
    return [_c("dt", {
